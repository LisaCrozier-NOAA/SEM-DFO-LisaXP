...
# Goal 2: Path Significance, Competitor Direction & Table 3 Generation
...
# Single Source of Truth for Naming and Node Definitions
...
cat("Running Goal 2 Significance & Competitor Evaluation Pipeline...\n")
...
# Unnest generic node indicator columns and join exclusively with master_crosswalk
...
# ------------------------------------------------------------------------------
# STEP 4: GENERATE MANUSCRIPT-READY TABLE 3 (WIDE FORMAT)
# ------------------------------------------------------------------------------
...
message("Goal 2 Pipeline Complete! Outputs exported to: ", master_out)
