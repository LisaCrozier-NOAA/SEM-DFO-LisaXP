...
# Requires:
# ranked_restrict (or res_shark_restrict with aic_test)
...
# 6) Save outputs
# ---------------------------
write_csv(mod_tbl, file.path(out_dir, "phase5_weighted_models_Q10_2_n19_n24.csv"))
write_csv(curve_tbl, file.path(out_dir, "phase5_overlap_curves_weighted_points.csv"))
write_csv(summary_curve, file.path(out_dir, "phase5_overlap_curves_weighted_summary.csv"))
write_csv(choice_imp, file.path(out_dir, "phase5_overlap_form_importance_Q10_2.csv"))

ggsave(file.path(out_dir, "phase5_overlap_curves_weighted_family.png"), p_curves, width = 10, height = 8, dpi = 150)
ggsave(file.path(out_dir, "phase5_overlap_curves_weighted_summary.png"), p_summary, width = 10, height = 8, dpi = 150)
ggsave(file.path(out_dir, "phase5_overlap_form_importance_Q10_2.png"), p_choice, width = 7, height = 5, dpi = 150)
