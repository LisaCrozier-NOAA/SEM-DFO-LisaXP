...
# ---------------------------
          ...
          ssl.predict[,ssl_var]<-pred_tbl %>% pull(ssl_weighted_pred_z)
           ...
           write_csv(par_tbl, file.path(out_dir, paste0("ssl_",ssl_var,"_best_parameters.csv")))
           write_csv(fit_metrics, file.path(out_dir, paste0("ssl_",ssl_var,"_fit_metrics.csv")))
           write_csv(pred_tbl, file.path(out_dir, paste0("ssl_",ssl_var,"_predictions.csv")))
...
ggsave(file.path(out_dir, paste0(ssl_var,"_ssl_model.png")), myplots, width = 6.2, height = 5.2, dpi = 170)
