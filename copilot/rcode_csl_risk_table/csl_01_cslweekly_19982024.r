...
#RESULTS:
# master_reconstructed<-read.csv(file.path(output_dir, "csl_reconstructed_weekly_1998_2024.csv"), row.names = NULL)
# ggsave(file.path(output_dir, "csl_weekly_reconstructed_faceted_1998_2024.png"), p_full_series, width = 12, height = 6)
...
p_full_series <- ggplot(master_reconstructed , aes(x = week)) +
...
# #Plot 3: all years in straight line to see relative abundances ---
p_full_series_continuous <- ggplot(master_reconstructed, aes(x = time_index)) +
...
print(p_full_series_continuous)
...
ggsave(file.path(output_dir, "csl_weekly_reconstructed_faceted_1998_2024.png"), p_full_series, width = 12, height = 6)
ggsave(file.path(output_dir, "csl_weekly_reconstructed_continuous_1998_2024.png"), p_full_series_continuous, width = 12, height = 6)
