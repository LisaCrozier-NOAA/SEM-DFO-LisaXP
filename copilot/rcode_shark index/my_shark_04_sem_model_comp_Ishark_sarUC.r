...
# -----------------------------------------------------------------------------
      ...
      names(guild.dfas1)
      length(which(!is.na(guild.dfas1$sar_uc))) 
      #18 years
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
     ...
     #           if (nrow(df_model) < 24) return(NULL)
                ...
                sem_text <- '
                  ...
                  sar_uc ~ x07_dfa_cpue_int_spr_jun_hw + Pred1 + Pred2
                '
...
# -----------------------------------------------------------------------------
          ...
          fit_base <- sem('
            x07_dfa_cpue_int_spr_jun_hw ~ x09_dfa_hake_age5plus
            sar_uc ~ x07_dfa_cpue_int_spr_jun_hw
...
# -----------------------------------------------------------------------------
  ...
  #2 Predators        
          ...
          all_competing_models[1,]
          
          all_competing_models[,c(1,2,3,11,13,15)]
                # term1_col                          term2_col                             n p_cpue_sar p_term1_sar p_term2_sar
                # 1 x15_salmon_shark_bsai_pred_ak      x13_stka_herr_matbiom                17    0.0160  0.000321     0.00000963
                # 2 x15_dfa_sleeper_shark_bsai_pred_ak x13_ammod_wai                        18    0.00767 0.000000184  0.000139  
                # 3 x15_ishark_z                       x21_sst_wgoa_coastwatch_junjulaug    18    0.885   0.00000953   0.00000248
                # 4 x15_salmon_shark_bsai_pred_ak      x13_egoa_herring                     17    0.0190  0.00133      0.0000995 
                # 5 x15_ishark_roll2                   x21_sst_wgoa_coastwatch_junjulaug    18    0.380   0.0000625    0.000120  
                # 6 x15_ishark_roll2                   x12_copepod_biomass_w_go_a           18    0.141   0.0107       0.000129  
                # 7 x15_salmon_shark_bsai_pred_ak      x12_copepod_biomass_w_go_a           17    0.554   0.482        0.000113  
                # 8 x15_spiny_dogfish_go_a_pred_ak     x15_shark_catch_go_a_pred_ak         18    0.205   0.00000140   0.00000215
                # 9 x15_spiny_dogfish_bsai_pred_ak     x13_wgoa_cap_pcod                    17    0.679   0.00249      0.0000416 
                # 10 x15_spiny_dogfish_bsai_pred_ak     x12_copepod_biomass_w_go_a           17    0.544   0.953        0.0000435 
                # 
                write_csv(all_competing_models, file.path(out_dir, "shark_sem_pred_prey_sarUC.csv"))
