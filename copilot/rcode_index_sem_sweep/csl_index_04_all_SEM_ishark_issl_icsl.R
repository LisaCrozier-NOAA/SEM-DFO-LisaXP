...
#RESULTS of aic comparison of all 2-var and 3-var SEMs

out_dir <- "copilot/outputs_6"
write.csv(all_models_aic,  file.path(out_dir, "sem_global_2var_3var_models_sorted_aic.csv"), row.names = FALSE)
...
# =========================================================
# Refit full model sets with new CSL index + variable importance
# =========================================================
...
# 0) Load base files
# ---------------------------
#guild_path <- "data_Lisa/guild_dfas1_24yr_ishark_issl_icsl.csv"
guild_path   <- file.path(out_dir, "guild_dfas1_24yr.csv")
csl_path   <- file.path(out_dir, "chinook_numeric_csl_exposure_risk_1998_2024.csv")

guild_raw <- read.csv(guild_path) %>%
  clean_names() %>%
...
write.csv(all_models,      file.path(out_dir, "sem_global_2var_3var_models_full.csv"), row.names = FALSE)
write.csv(all_models_aic,  file.path(out_dir, "sem_global_2var_3var_models_sorted_aic.csv"), row.names = FALSE)
write.csv(all_models_r2,   file.path(out_dir, "sem_global_2var_3var_models_sorted_r2.csv"), row.names = FALSE)
write.csv(var_importance,  file.path(out_dir, "sem_global_variable_importance_aicweights.csv"), row.names = FALSE)
